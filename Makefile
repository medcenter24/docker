build:
	# PostGreSQL setup
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-postgres
	...
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-build
	...
	# stop everything
	docker-compose -f ./docker_mc/docker-compose.yaml down
...
run:
	...
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-build
	# PhpFpm for mcCore
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-phpfpm
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-backoffice-nginx
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-api-nginx
	# PgSql
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-postgres
	# Director watch (dev version with file observer)
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-director-watch
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-director-watch-nginx
	# Doctor watch
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-doctor-watch
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-doctor-watch-nginx
	# Director Prod Dist
	docker-compose -f ./docker_mc/docker-compose.yaml up -d mc-director-dist-nginx
